...
import logo from '../assets/img/logo_ugi.png';
      ...
      <Navbar expand="md" className={scrolled ? "scrolled" : ""}>
        <Container>
          <Navbar.Brand href="/">
            ...
            {/* <span className="span.navbar-text">Chain dev</span> */}
          </Navbar.Brand>
          ...
          <Navbar.Collapse id="basic-navbar-nav">
            ...
            <span className="navbar-text">
              <div className="social-icon">
                ...
                {/* <a href="https://www.instagram.com/mr._e_v_i_l/" target="_blank"><img src={navIcon3} alt="" /></a> */}
              </div>
              <HashLink to='#connect'>
